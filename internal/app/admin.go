...
func registerAdminRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/admin/api/accounts/test", adminAuth(corsHandler(handleAdminAccountTest)))
	mux.HandleFunc("/admin/api/oauth/start", adminAuth(corsHandler(handleOAuthStart)))
	mux.HandleFunc("/admin/api/oauth/status", adminAuth(corsHandler(handleOAuthStatus)))
	mux.HandleFunc("/admin/api/sso/import", adminAuth(corsHandler(handleSSOImport)))
	mux.HandleFunc("/admin/api/stats", adminAuth(corsHandler(handleAdminStats)))
	mux.HandleFunc("/admin/api/batch-import", adminAuth(corsHandler(handleBatchImport)))
	mux.HandleFunc("/admin/api/accounts/refresh-all", adminAuth(corsHandler(handleAdminRefreshAll)))
	mux.HandleFunc("/admin/api/accounts/delete-all", adminAuth(corsHandler(handleAdminDeleteAll)))
	mux.HandleFunc("/admin/api/accounts/reset", adminAuth(corsHandler(handleAdminAccountReset)))
	mux.HandleFunc("/admin/api/accounts/export", adminAuth(corsHandler(handleAccountsExport)))
	mux.HandleFunc("/admin/api/logs", adminAuth(corsHandler(handleRequestLogs)))
	mux.HandleFunc("/admin/api/keys", adminAuth(corsHandler(handleAdminGetKeys)))
	mux.HandleFunc("/admin/api/keys/generate", adminAuth(corsHandler(handleAdminGenerateKey)))
	mux.HandleFunc("/admin/api/keys/delete", adminAuth(corsHandler(handleAdminDeleteKey)))
	mux.HandleFunc("/admin/api/models", adminAuth(corsHandler(handleAdminModels)))
	mux.HandleFunc("/admin/api/models/refresh", adminAuth(corsHandler(handleAdminModelsRefresh)))
	mux.HandleFunc("/admin/api/config", adminAuth(corsHandler(handleAdminConfig)))
	mux.HandleFunc("/admin/api/config/update", adminAuth(corsHandler(handleAdminUpdateConfig)))
	mux.HandleFunc("/admin/api/opencode/config", adminAuth(corsHandler(handleZenConfig)))
	mux.HandleFunc("/admin/api/opencode/config/update", adminAuth(corsHandler(handleZenConfigUpdate)))
	mux.HandleFunc("/admin/api/opencode/models", adminAuth(corsHandler(handleZenModels)))
	mux.HandleFunc("/admin/api/opencode/models/refresh", adminAuth(corsHandler(handleZenModelsRefresh)))
	mux.HandleFunc("/admin/api/opencode/stats", adminAuth(corsHandler(handleZenStats)))
	// 旧 zen 路径别名,兼容旧引用
	mux.HandleFunc("/admin/api/zen/config", adminAuth(corsHandler(handleZenConfig)))
	mux.HandleFunc("/admin/api/zen/config/update", adminAuth(corsHandler(handleZenConfigUpdate)))
	mux.HandleFunc("/admin/api/zen/models", adminAuth(corsHandler(handleZenModels)))
	mux.HandleFunc("/admin/api/zen/models/refresh", adminAuth(corsHandler(handleZenModelsRefresh)))
	mux.HandleFunc("/admin/api/zen/stats", adminAuth(corsHandler(handleZenStats)))
